...
<nav class="navbar navbar-expand-md sticky-top px-0">
			...
			<div class="collapse navbar-collapse justify-content-between" id="collapsibleNavbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
							<a class="nav-link" href="${pageContext.request.contextPath}/bookList">List Book</a> 
					</li>
					
					<li class="nav-item">
							<a class="nav-link" href="${pageContext.request.contextPath}/createBook">Create Book</a>
					</li>
				...
				<div class="d-flex">
					<form class="form-inline" method="GET" action="${pageContext.request.contextPath}/searchBook">
					...
					<div class="text-danger">
						<h6>Hello, ${sessionScope.username}</h6>
					</div>
